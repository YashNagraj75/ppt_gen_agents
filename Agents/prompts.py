...
The layout schema that you need to provide text for is : {layout_schema}

1.  **Examine Target Layout & Placeholders:**
...
*   **Input:** `layout: "contentFull"`, `title: "Benefits of Exercise"`, `{content}` (a long paragraph detailing many benefits), `{layout_schema}` (specifying a 100-word limit for `content` in `contentFull`).
*   **Process:**
...
Current Task Context:
    ...
    The schema of the layout with the output json body : {layout_schema}
...
Your Step-by-Step Process:
  ...
  1.  Analyze Target Layout Schema & Identify Placeholders:
    Examine the  schema that is given,  carefully to identify all placeholders that need content (e.g., subtitle, content, colLeft, image, table, chart, caption, step1Text, milestone1Lower, media, contactInfo, etc.).
  ...
  2.  Iterate Through Placeholders and Invoke Agents:
    ...
    For a given placeholder:
        ...
        If the appropriate agent for the placeholder's type is available in your current list:
            Prepare the necessary inputs for that specific agent. Common inputs will likely include {layout_name}, {title}, and the content needed, but check the agent's specific requirements if defined.
  ...
  3.  Assemble Final Slide Data:
    Construct the final JSON object for the slide, strictly according to the schema given above.
...
"milestone2Upper": "Date / Event 2 Title",
"milestone3Upper": "Date / Event 3 Title",
"milestone4Upper": "Date / Event 4 Title",
"milestone1Lower": "Description for milestone 1...",
"milestone2Lower": "Description for milestone 2...",
"milestone3Lower": "Description for milestone 3...",
"milestone4Lower": "Description for milestone 4..."
