...
1) Content Analysis: Start out by analyzing this content {content} . Start by summarizing the key information from the content. Identify main messages, data points, or visual elements like images ,charts or tables that stand out. 
...
1) layout: The layout name
2) title: The title for that layout
