...
1.  **Identify Target Layout & Placeholders:**
  ...
  **Consult Constraints:**
    *   Carefully review the `Tips` section associated with the target layout in the layouts list.
...
**Example Scenario:**
*   **Input:** `layout: "contentTwoCol"`, `title: "Pros and Cons of Remote Work"`, `{content}` (source text detailing advantages and disadvantages), from the slide layouts given above follow this process.
*   **Process:**
